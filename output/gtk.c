...
#line 110 "gtk.chpl"
  chpl_check_nil(call_tmp_chpl2, INT64(110), "./gtk.chpl");
#line 110 "gtk.chpl"
  ret_chpl3 = (call_tmp_chpl2)->dom;
#line 110 "gtk.chpl"
  chpl_check_nil(ret_chpl3, INT64(110), "./gtk.chpl");
#line 110 "gtk.chpl"
  call_tmp_chpl3 = dsiMember(ret_chpl3, &this_chpl, INT64(110), "./gtk.chpl");
#line 110 "gtk.chpl"
  call_tmp_chpl4 = (! call_tmp_chpl3);
#line 110 "gtk.chpl"
  if (call_tmp_chpl4) /* ZLINE: 110 ./gtk.chpl */
#line 110 "gtk.chpl"
  {
#line 110 "gtk.chpl"
    string_from_c_string(&call_tmp_chpl5, "array index out of bounds: ", INT64(0), INT64(0), INT64(110), "./gtk.chpl");
#line 110 "gtk.chpl"
    halt3(call_tmp_chpl5, &this_chpl, INT64(110), "./gtk.chpl");
#line 110 "gtk.chpl"
  }
#line 110 "gtk.chpl"
  sum_chpl = INT64(0);
...
#line 110 "gtk.chpl"
  c_string_from_string(&call_tmp_chpl8, &ret_chpl5, INT64(110), "./gtk.chpl");
#line 110 "gtk.chpl"
