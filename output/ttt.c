...
#line 3 "ttt.chpl"
  call_tmp_chpl3 = chpl__buildArrayRuntimeType3(call_tmp_chpl2, INT64(3), "ttt.chpl");
#line 3 "ttt.chpl"
...
#line 15 "ttt.chpl"
  call_tmp_chpl4 = chpl_config_has_value("callPotentiallyDeadFunctions", "ttt");
#line 15 "ttt.chpl"
  call_tmp_chpl5 = (! call_tmp_chpl4);
#line 15 "ttt.chpl"
  if (call_tmp_chpl5) /* ZLINE: 15 ttt.chpl */
#line 15 "ttt.chpl"
  {
#line 15 "ttt.chpl"
    const_tmp_chpl = false;
#line 15 "ttt.chpl"
  } else /* ZLINE: 15 ttt.chpl */
#line 15 "ttt.chpl"
  {
#line 15 "ttt.chpl"
    call_tmp_chpl6 = chpl_config_get_value("callPotentiallyDeadFunctions", "ttt");
#line 15 "ttt.chpl"
    const_tmp_chpl = _command_line_cast15(call_tmp_chpl6, INT64(0), "<command line setting of 'callPotentiallyDeadFunctions'>");
#line 15 "ttt.chpl"
  }
#line 15 "ttt.chpl"
  callPotentiallyDeadFunctions_chpl = const_tmp_chpl;
#line 1 "ttt.chpl"
  *(refIndentLevel_chpl) -= INT64(1);
#line 1 "ttt.chpl"
...
#line 1 "ttt.chpl"
  c_ptr_GtkButton_chpl call_tmp_chpl = NULL;
#line 8 "ttt.chpl"
  call_tmp_chpl = GTK_BUTTON(btn);
#line 8 "ttt.chpl"
  gtk_button_set_label(call_tmp_chpl, "Changed");
#line 9 "ttt.chpl"
  gtk_widget_show(btn);
#line 7 "ttt.chpl"
  return;
...
#line 38 "ttt.chpl"
  g_signal_connect(call_tmp_chpl9, "clicked", call_tmp_chpl11, nil);
#line 41 "ttt.chpl"
...
#line 44 "ttt.chpl"
  chpl_checkIfRangeIterWillOverflow(INT64(1), INT64(3), INT64(1), INT64(1), INT64(3), true, INT64(44), "ttt.chpl");
#line 45 "ttt.chpl"
...
#line 44 "ttt.chpl"
    i_chpl2 = i_chpl;
#line 45 "ttt.chpl"
    chpl_checkIfRangeIterWillOverflow(INT64(1), INT64(3), INT64(1), INT64(1), INT64(3), true, INT64(45), "ttt.chpl");
#line 47 "ttt.chpl"
...
#line 18 "ttt.chpl"
  cast_tmp_chpl = chpl_here_alloc(call_tmp_chpl, INT16(1), INT64(18), "ttt.chpl");
#line 18 "ttt.chpl"
...
#line 18 "ttt.chpl"
  chpl_check_nil(this_chpl, INT64(18), "ttt.chpl");
#line 18 "ttt.chpl"
...
#line 18 "ttt.chpl"
  wrap_call_tmp_chpl = _construct_atomic_int64(ret_chpl, &this_chpl2, INT64(18), "ttt.chpl");
#line 18 "ttt.chpl"
  chpl_check_nil(this_chpl, INT64(18), "ttt.chpl");
#line 18 "ttt.chpl"
...
#line 18 "ttt.chpl"
  wrap_call_tmp_chpl2 = _construct__EndCount(&wrap_call_tmp_chpl, INT64(0), ret_chpl2, this_chpl, INT64(18), "ttt.chpl");
#line 18 "ttt.chpl"
  chpl_rt_preUserCodeHook();
#line 18 "ttt.chpl"
  chpl__init_ttt(INT64(18), "ttt.chpl");
#line 18 "ttt.chpl"
  _main_args_chpl = chpl_convert_args(_arg, INT64(18), "ttt.chpl");
#line 18 "ttt.chpl"
  chpl_user_main(_main_args_chpl);
#line 18 "ttt.chpl"
  chpl_rt_postUserCodeHook();
#line 18 "ttt.chpl"
  _waitEndCount2(wrap_call_tmp_chpl2, INT64(18), "ttt.chpl");
