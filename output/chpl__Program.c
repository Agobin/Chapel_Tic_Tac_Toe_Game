...
#line 20 "AtomicsCommon.chpl"
  chpl__init_AtomicsCommon_p = UINT8(false);
...
#line 1 "gtk.chpl"
  chpl__init_gtk_p = UINT8(false);
#line 1 "gtk_types.chpl"
  chpl__init_gtk_types_p = UINT8(false);
#line 31 "Assert.chpl"
  chpl__init_Assert_p = UINT8(false);
#line 168 "CommDiagnostics.chpl"
  chpl__init_CommDiagnostics_p = UINT8(false);
...
#line 38 "Error.chpl"
  chpl__init_Error_p = UINT8(false);
