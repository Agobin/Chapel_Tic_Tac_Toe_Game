...
const chpl__class_id chpl__cid__syncvar_chpl_bool = 18;
const chpl__class_id chpl__cid_DefaultDist = 19;
const chpl__class_id chpl__cid_DefaultRectangularDom_1_int64_t_F = 20;
const chpl__class_id chpl__cid_DefaultRectangularArr_c_ptr_GtkWidget_1_int64_t_F = 21;
const chpl__class_id chpl__cid_DefaultRectangularArr_chpl_string_1_int64_t_F = 22;
const chpl__class_id chpl__cid_DefaultRectangularArr_int64_t_1_int64_t_F = 23;
const chpl__class_id chpl__cid_DefaultRectangularArr_locale_1_int64_t_F = 24;
const chpl__class_id chpl__cid_DefaultRectangularArr_localesSignal_1_int64_t_F = 25;
const chpl__class_id chpl__cid_LocaleModel = 26;
const chpl__class_id chpl__cid_RootLocale = 27;
const chpl__class_id chpl__cid__class_localscoforall_fn2 = 28;
const chpl__class_id chpl__cid_object = 29;
const chpl__class_id chpl__cid_listNode_BaseArr_chpl = 30;
const chpl__class_id chpl__cid_listNode_BaseDom_chpl = 31;
const chpl__class_id chpl__cid_string_refcnt_chpl = 32;
const chpl__class_id chpl__cid_RandomStream__real64_T_chpl = 33;
const chpl__class_id chpl__cid_c_ptr_GtkButton_chpl = 34;
const chpl__class_id chpl__cid_c_ptr_GtkContainer_chpl = 35;
const chpl__class_id chpl__cid_c_ptr_GtkLabel_chpl = 36;
const chpl__class_id chpl__cid_c_ptr_GtkTable_chpl = 37;
const chpl__class_id chpl__cid_c_ptr_GtkWidget_chpl = 38;
const chpl__class_id chpl__cid_c_ptr_GtkWindow_chpl = 39;
const chpl__class_id chpl__cid_c_ptr_int64_t_chpl = 40;
/*** Class Prototypes ***/
...
typedef struct chpl_RandomStream__real64_T_chpl_s* RandomStream__real64_T_chpl;
/*** Enumerated Types ***/
...
typedef RandomStream__real64_T_chpl *_ref_RandomStream__real64_T;
...
typedef struct chpl__class_localscoforall_fn_s {
  ...
  int64_t _4_len;
  chpl___EndCount_atomic_int64_int64_t _5_rvfDerefTmp;
  int64_t _ln;
  c_string _fn;
...
typedef struct chpl_RandomStream__real64_T_chpl_s /* : object */ {
  chpl_object_object super_chpl;
  int64_t seed_chpl;
  _syncvar_chpl_bool RandomStreamPrivate_lock_DOLLAR__chpl;
  _real64 RandomStreamPrivate_cursor_chpl;
  int64_t RandomStreamPrivate_count_chpl;
} chpl_RandomStream__real64_T_chpl_object;
...
static void init_elts2(_ddata_c_ptr_GtkWidget x, int64_t s, int64_t _ln, c_string _fn);
...
static void init_elts5(_ddata_localesSignal x, int64_t s, int64_t _ln, c_string _fn);
...
static c_string _command_line_cast13(c_string x);
static c_string _command_line_cast14(c_string x);
...
static void coforall_fn(_ddata_int64_t x1_tet, int64_t chunk, int64_t numChunks, _ref_range_int64_t_bounded_F this6, int64_t len, chpl___EndCount_atomic_int64_int64_t _coforallCount, int64_t _ln, c_string _fn);
...
static void ioerror_chpl2(syserr error_chpl, chpl_string msg_chpl, chpl_string path_chpl, int64_t offset_chpl, int64_t _ln_chpl, c_string _fn_chpl);
